...
public class PatientPdfView extends AbstractPdfView {
	...
	{
		HeaderFooter header = new HeaderFooter(new Phrase("PATIENT PDF VIEW"), false);
	...
	protected void buildPdfDocument(
		...
		Paragraph title = new Paragraph("PATIENT DATA",titleFont);
		...
		table.addCell(new Phrase("PATIENT NAME",tableHead));
		table.addCell(new Phrase("PATIENT PHONE",tableHead));
